...
security create-keychain -p "1377Alireza1377" build3.keychain
security import ./secrets/Certificates.p12 -t agg -k ~/Library/Keychains/build3.keychain -P "1377Alireza1377" -A

security list-keychains -s ~/Library/Keychains/build3.keychain
security default-keychain -s ~/Library/Keychains/build3.keychain
security unlock-keychain -p "1377Alireza1377" ~/Library/Keychains/build3.keychain

security set-key-partition-list -S apple-tool:,apple: -s -k "1377Alireza1377" ~/Library/Keychains/build3.keychain
